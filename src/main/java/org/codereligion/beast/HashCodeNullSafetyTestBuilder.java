 ...
 * @since 11.08.2012
 */
public final class HashCodeNullSafetyTestBuilder {
	...
	public HashCodeNullSafetyTestBuilder addCustomInstanceProvider(final CustomInstanceProvider<?> customInstanceProvider) {
	...
	public HashCodeNullSafetyTestBuilder addCustomInstanceProviders(final Set<CustomInstanceProvider<?>> customInstanceProviders) {
