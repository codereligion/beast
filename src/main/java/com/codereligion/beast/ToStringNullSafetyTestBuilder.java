...
/**
 * Builder for the toString null-safety test. The resulting test will apply the following criteria to the class under test:
 * <p/>
 * <ul> <li> the hashCode method must be implemented <li> calling toString for properties with {@code null} values, which have not been excluded must not throw
