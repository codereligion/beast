...
public abstract class AbstractNullSafetyTest extends AbstractTest {
     ...
     * <p/>
     * <ul> <li> it is not {@code null} <li> it is an instance of {@link AbstractNullSafetyTest} <li> the given object has the same {@code beanClass} as this
     * object <li> the given object has the same {@code objectFactory} as this object <li> the given object has the same {@code excludedPropertyNames} as this
     * object </ul>
     * <p/>
