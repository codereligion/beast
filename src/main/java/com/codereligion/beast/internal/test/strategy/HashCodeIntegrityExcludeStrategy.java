...
/**
 * Tests the integrity of the hashCode implementation by using an exclude strategy. This means the user can provide excluded properties which must not be
 * included in the hashCode implementation. This approach is specifically useful when the class under test has properties of which the majority must be
 * considered in the hashCode implementation.
 * <p/>
 * <p/>
 * This strategy will throw an {@link AssertionError} if it finds a property which has not been excluded by the user and is not included in the hashCode
 * implementation.
 * <p/>
 * <p/>
 * Furthermore it will throw an {@link AssertionError} if it finds a property which has been excluded by the user but is included in the hashCode
...
public final class HashCodeIntegrityExcludeStrategy extends AbstractIntegrityExcludeStrategy {
    ...
    public void apply(final Object defaultObject, final Object dirtyObject, final String propertyName) {
        ...
        assertFalse(isUnintentionallyMissing, "The property '%s' may not be included in the hashCode implementation or the generated hashCode " +
                                              "may be to weak to reflect changes in this property. If the property is not included and this is " +
                                              "intentional add it to the excludedPropertyNames.", propertyName);
        ...
        assertFalse(isUnnecessarilyExcluded, "The property '%s' is contained the excludedPropertyNames, but is actually " +
                                             ...
                                             "excludedPropertyNames or the hashCode implementation.", propertyName);
    }
