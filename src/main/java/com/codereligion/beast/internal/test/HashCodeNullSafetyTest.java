 ...
 * <p/>
 * <ul> <li> the hashCode method must be implemented <li> calling hashCode for properties with {@code null} values, which have not been excluded must not throw
 * a {@link NullPointerException} <li> calling hashCode for properties with {@code null} values, which have been excluded must throw a {@link
...
public final class HashCodeNullSafetyTest extends AbstractNullSafetyTest {
     ...
     */
    public HashCodeNullSafetyTest(final Class<?> beanClass, final ObjectFactory objectFactory, final Set<String> excludedPropertyNames) {
