...
public class IntegrityStrategyEqualsTest {
    ...
    private static final Set<IntegrityStrategy> CLASSES = Sets.<IntegrityStrategy>newHashSet(new EqualsIntegrityIncludeStrategy(PROPERTY_NAMES),
    ...
    private void testBasicEqualsContract(final IntegrityStrategy integrityStrategyA, final IntegrityStrategy integrityStrategyB) {
