...
public class ObjectFactoryDirtyTest extends AbstractObjectFactoryTest {
    ...
    public Object getObject(final Class<?> beanClass, final String propertyName) {
        ...
        return objectFactory.getDirtyObject(beanClass, propertyName);
    }
    ...
    @Test
    public void givenIntegerArrayShouldReturnAnArrayWithLengthOneAndElementOfValueOne() {
    ...
    @Test
    public void givenEnumShouldReturnTheEnumWithOrdinalOne() {
    ...
    public void givenCustomInstanceProviderForBigDecimalSetShouldReturnProxyWhichIsAnInstanceOfSetWithItemOfDefaultValue() {
        ...
        assertEquals(BigDecimal.TEN, ((Set<?>) result).iterator().next());
    }

    @Test
    public void givenComplexClassShouldReturnAnInstanceWhichCompliesToEqualsContractAndReturnOneOnHashCodeAndToString() {
        ...
        assertEquals(1, complexObject1.hashCode());
        assertEquals("1", complexObject1.toString());
