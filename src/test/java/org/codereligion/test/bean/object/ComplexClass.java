...
public class ComplexClass {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((anotherComplexObject == null) ? 0 : anotherComplexObject
						.hashCode());
		result = prime * result + Arrays.hashCode(anotherComplexObjectArray);
		result = prime
				* result
				+ ((anotherComplexObjectCollection == null) ? 0
						: anotherComplexObjectCollection.hashCode());
		result = prime
				* result
				+ ((anotherComplexObjectList == null) ? 0
						: anotherComplexObjectList.hashCode());
		result = prime
				* result
				+ ((anotherComplexObjectMap == null) ? 0
						: anotherComplexObjectMap.hashCode());
		result = prime
				* result
				+ ((anotherComplexObjectSet == null) ? 0
						: anotherComplexObjectSet.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (anotherComplexObject == null) {
			...
			return false;
		if (!Arrays.equals(anotherComplexObjectArray,
				other.anotherComplexObjectArray))
			return false;
		if (anotherComplexObjectCollection == null) {
			if (other.anotherComplexObjectCollection != null)
				return false;
		} else if (!anotherComplexObjectCollection
				.equals(other.anotherComplexObjectCollection))
			return false;
		if (anotherComplexObjectList == null) {
			if (other.anotherComplexObjectList != null)
				return false;
		} else if (!anotherComplexObjectList
				.equals(other.anotherComplexObjectList))
			return false;
		if (anotherComplexObjectMap == null) {
			if (other.anotherComplexObjectMap != null)
				return false;
		} else if (!anotherComplexObjectMap
				.equals(other.anotherComplexObjectMap))
			return false;
		if (anotherComplexObjectSet == null) {
			if (other.anotherComplexObjectSet != null)
				return false;
		} else if (!anotherComplexObjectSet
	...
	public String toString() {
		...
		builder.append(Arrays.toString(anotherComplexObjectArray));
